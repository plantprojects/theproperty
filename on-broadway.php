	...
	<div id="intro">
		...
		<div class="info">
			...
			<div id="pr" class="center">
				...
				<p>The exhibition is free and open to the public and there is $5.50 parking available above the venue, cash only. The Property would like to thank the ownership group of 440 South Broadway, Brian Abdi of Bridge Real Estate and <a href="http://civiccenterstudios.com/" target="_blank">Civic Center Studios</a> for their generous support.</p>
			</div>
