...
<head>
	...
	<meta property="og:description" content="440 Broadway, Mezzanine, Los Angeles, CA. Opening Reception: Thursday, August 28th, 2014, 7-10pm.
	The Property is pleased to announce Open House, the organization's inaugural group exhibition, featuring the work of Amy Sarkisian, Dave Hughes, Bettina Hubby, Sarah Bostwick, Karen Lofgren, Jon-Paul Villegas, Liz Walsh, Chris Oliveria and Evan Ellsworth Jourden." />
...
<body class="<?php if ( $detect->isMobile() ) { ?>device<?php } else { ?>computer<?php } ?>">
	...
	<section id="press-release">
		<div class="centered page-3">
			...
			<p><i>The Property</i> is pleased to announce <i>Open House</i>, the organization's inaugural group exhibition, featuring the work of Amy Sarkisian, Dave Hughes, Bettina Hubby, Sarah Bostwick, Karen Lofgren, Jon-Paul Villegas, Liz Walsh, Chris Oliveria and Evan Ellsworth&nbsp;Jourden.</p>
