		...
		<div class="centered page-3">
			...
			<ul id="content">
				<li id="press-release" class="active">
					...
					<p>The Property is pleased to announce <i>Put It Together Take It Apart</i>, new paintings by Los Angeles based artist <b>Christopher Oliveria</b>.
						An opening reception will take place <b>January 17th, 2015, 7 - 10pm</b>, with the exhibition on view through February 7th.</p>

					<p>The gallery is currently closed for installation till January 17th, 2015.</p>

					<p>Thank you to all who joined us for <i><a href="http://theproperty.gallery/on-broadway">On Broadway</a></i> in December with a special thanks to everyone who helped make the three night mini-mall multi-media exhibition possible!</p>
